...
const int	NN  = 9;	//#define NN	7    // center value
//const int	NN  = 7;	//#define NN	7    // center value
//const int	NN  = 5;	//#define NN	7    // center value
//const int	NN  = 3;	//#define NN	7    // center value
const int       N3  = static_cast<int>(NN * 0.5 + 0.5);
...
//const int    REPEAT = 30;	// 80, 101(limit), 102(illeagle), 
...
//};
const Point pnt_r1(pnt_r0.x + L1*cos(rth1), pnt_r0.y + L1*sin(rth1), pnt_r0.z);
